...
var TPSCameraControl = function (_EventDispatcher) {
	...
	function TPSCameraControl(camera, trackObject) {
		...
		_this.rotationMatrix = new THREE$1.Matrix4();
		_this.rotationX = new THREE$1.Matrix4();
		_this.rotationY = new THREE$1.Matrix4();
...
export { install, World, Octree, AnimationController, CharacterController, KeyInputControl, TPSCameraControl };
